...
<div id="main-content">
	...
	$video = wp_oembed_get(get_field('video_url'));
						...
						<article id="post-<?php the_ID(); ?>" <?php post_class('module single-post-module'); ?>>
							...
							<div class="post-wrap">
								<?php if (!extra_is_builder_built()) { ?>
									...
									<tbody>
									<tr>
									<td><h5>I Date Approved: </h5> ' . ($date_approved ? $date_approved : "") . '</td>
									<td><h5>II Date Revised: </h5> ' . ($date_revised ? $date_revised : "") . '</td>
									</tr>
									<tr>
									<td><h5>III Approved By: </h5> ' . ($approved_by ? $approved_by : "") . '</td>
									</tr>
									</tbody>
									</table>
									<br><br>';
