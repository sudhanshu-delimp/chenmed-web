...
<div id="main-content">
	...
	$subtopic = get_field('subtopic');
	$date = get_field('original_effective_date');
	$revision = get_field('revision_date');
	$summary = get_field('job_aid_body');
							...
							<div class="post-wrap">
								<?php if (!extra_is_builder_built()) { ?>
									<div class="post-content entry-content">
										<?php
										if ($topic || $subtopic || $date || $revision) {
											echo '<table style="width: 100%;" border="1" cellpadding="6">
                                    <tbody>
                                    <tr>
                                    <td><h5> Topic:</h5> ' . ($topic ? $topic : "") . '</td>
                                    <td><h5> Sub-Topic:</h5> ' . ($subtopic ? $subtopic : "") . '</td>
                                    </tr>
									<tr>
									<td><h5> Original Effective Date:</h5> ' . ($date ? $date : "") . '</td>
                                    <td><h5> Revision Date:</h5>' . ($revision ? $revision : "") . '</td>
                                    </tr>
                                    </tbody>
                                    </table>';
										}
