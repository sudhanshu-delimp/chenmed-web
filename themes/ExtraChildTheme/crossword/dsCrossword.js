			...
			if ( $t.opt.responsive ) {
	 	    ...
	 	    if ( $t.opt.activeCluePosition != false ) {
	 	    	...
	 	    	if ( $t.opt.activeCluePosition == 'top' ) {
	 	    		$t.puzDiv.prepend( 'Find answers on Asian American Pacific Islander Month emails. Guess the identity of these health care heroes.' + activeClueBox );
	 	    	} else {
	 	    		$t.puzDiv.append( 'Find answers on Asian American Pacific Islander Month emails. Guess the identity of these health care heroes.' + activeClueBox );
	 	    	}
