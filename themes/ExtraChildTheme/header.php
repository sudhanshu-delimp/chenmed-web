...
<head>
	...
	<?php wp_head(); ?>
	<link rel="preload" as="font" href="/content/themes/Extra/fonts/ET-Extra.woff" type="font/woff2" crossorigin="anonymous" />
	<link rel="preload" as="font" href="/content/themes/Extra/core/admin/fonts/modules.ttf" type="font/ttf" crossorigin="anonymous" />
	<link rel="preconnect" href="//fonts.gstatic.com" />
	<link rel="preconnect" href="//kit-free.fontawesome.com" />
</head>
<body <?php body_class(); ?>>
<?php
					...
					<?php if ( '' !== $header_vars['secondary_nav'] ) { ?>
						...
						<?php if ( $header_vars['output_header_trending_bar'] ) { ?>
							...
							<div id="et-trending">
								...
								<!-- ET Trending Button -->
								<a id="et-trending-button" href="#" title="ChenMed Way">
									<span>ChenMed Way</span>
									<span></span>
									<span></span>
								</a>
								...
								<h4 id="et-trending-label">
									<?php esc_html_e( 'SERVICE STANDARD', 'extra' ); ?>
								</h4>
								...
								<?php if ( $header_vars['trending_posts']->have_posts() ) : ?>
									...
									?>
										<div id="et-trending-post-<?php the_ID(); ?>" class="<?php echo esc_attr( $trending_post_classes ); ?>">
											<a href="<?php the_permalink(); ?>"><?php echo esc_html( truncate_title( 130 ) ); ?></a>
										</div>
									<?php
										$trending_post_count++;
									endwhile;
