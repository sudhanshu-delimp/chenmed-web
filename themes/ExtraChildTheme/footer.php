<?php $footer_above_ad = extra_display_ad( 'footer_above', false ); ?>
	...
	<footer id="footer" class="<?php extra_footer_classes(); ?>">
		...
		<div id="footer-bottom">
			<div class="container">
				...
				<!-- Footer Info -->
				<p id="footer-info"><?php printf( et_get_safe_localization( __( '', '' ) ), '<a href="" title=""></a>', '<a href="http://www.wordpress.org"></a>' ); ?></p>
	...
	<?php wp_enqueue_script('caldera-script', get_stylesheet_directory_uri() . '/caldera-script.js', ['jquery'], 2.0, true); ?>
	<?php wp_enqueue_script('custom-script', get_stylesheet_directory_uri() . '/custom-script.js', ['jquery'], 1.0, true); ?>
	<?php wp_footer(); ?>
</body>
</html>
